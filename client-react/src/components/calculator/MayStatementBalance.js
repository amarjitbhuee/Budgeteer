...
class MayStatementBalance extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            transactionsIncome: [],
    ...
    getIncome = () => {
        let url = "http://localhost:3001/transactions/incomeMay";
        axios.get(url)
    ...
    getExpense = () => {
        let url = "http://localhost:3001/transactions/expenseMay"; 
        axios.get(url)
...
export default MayStatementBalance; 