...
class OctStatementBalance extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            transactionsIncome: [],
    ...
    getIncome = () => {
        let url = "http://localhost:3001/transactions/incomeOctober";
        axios.get(url)
    ...
    getSavings = () => {
        let url = "http://localhost:3001/transactions/savingsOctober"; 
        axios.get(url)
...
export default OctStatementBalance; 