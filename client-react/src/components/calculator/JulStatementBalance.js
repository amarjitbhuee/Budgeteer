...
class JulStatementBalance extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            transactionsIncome: [],
    ...
    getIncome = () => {
        let url = "http://localhost:3001/transactions/incomeJuly";
        axios.get(url)
    ...
    getSavings = () => {
        let url = "http://localhost:3001/transactions/savingsJuly"; 
        axios.get(url)
...
export default JulStatementBalance; 